...
**Use framework routing components/hooks. NEVER import from `react-router-dom` directly.** Framework handles SPA navigation, Outlet, and overlay closing automatically.
